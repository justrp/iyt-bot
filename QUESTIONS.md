...
* D
# vhf_1.yml
<h3><pre>Какой канал предназначен только для передачи цифровых данных ?
</pre></h3>
* **CORRECT: 70**
* 10
* 72
...
* D
# navigation_03.yml
<h3><pre>Угол, измеренный от направления на истинный север до направления на северный магнитный полюс, это:
A) Склонение
B) Девиация
C) Ангуляция
D) Демаркация
...
* **CORRECT: D**
# navigation_02.yml
<h3><pre>Если на плане или на частной карте, при выполнении обсервации, образовался треугольник невязки, и при этом, рядом с треугольником находится навигационная опасность, то принято считать, что:
A) Судно в любом случае находится в центре треугольника невязки
B) Судно находится в пределах треугольника, но на минимальном расстоянии до опасности
</pre></h3>
* A
* **CORRECT: B**
# mppss_15.yml
...
* **CORRECT: D**
# navigation_04.yml
<h3><pre>Линия положения или ... — это линия (начерченная на карте), в определенном месте, на которой располагается судно.
</pre></h3>
* POV
* **CORRECT: LOP**
* VIP
...
* D
# vhf_02.yml
<h3><pre>В каких случаях используется передача сообщений SECURITE ?
A. Сигнал безопасности обычно используется береговой радиостанцией. Он говорит о том, что следом будет передано важное сообщение, например, о навигационной опасности или штормовое предупреждение.
В. Сигнал крайней необходимости. При подаче сигнала кодовые слова происносятся трижды. Сообщение вызова крайне необходимости обычно посылают на частотах бедствия.
</pre></h3>
* **CORRECT: A**
* B
